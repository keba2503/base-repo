...
export const derivedSteps: readonly string[] = [
  ...
  "If this repository is private, code scanning needs GitHub Code Security enabled for the account. Without it, disable `.github/workflows/codeql.yml` under **Actions** rather than making it report green without scanning (`docs/decisions/0031`).",
